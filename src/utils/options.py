...
class Options:
    ...
    driver_to_spectrum_identity: str = "DRIVER_SPECTRUM_IDEN"
    driverrx_to_spectrum_identity: str = "DRIVERRX_SPECTRUM_IDEN"
    ...
    spectrum_to_driver_identity: str = "SPECTRUM_DRIVER_IDEN"
    spectrum_to_driverrx_identity: str = "SPECTRUM_DRIVERRX_IDEN"
    spectrum_to_radctrl_identity: str = "SPECTRUM_RADCTRL_IDEN"
    ...
    radctrl_to_spectrum_identity: str = "RADCTRL_SPECTRUM_IDEN"
