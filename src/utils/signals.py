...
class DSP:
    ...
    def beamform(self, beam_phases: np.ndarray):
        """
        ...
        :param  beam_phases:    The complex phases used to beamform the filtered samples.
                                Expects shape [num_slices, num_beams, num_channels].
        :type   beam_phases:    np.ndarray
        """
        # beam_phases: [num_slices, num_beams, num_channels]
    ...
    def beamform_samples(filtered_samples, beam_phases):
        ...
        :type       filtered_samples:  ndarray [num_slices, num_channels, num_samples]
        :param      beam_phases:       The beam phases used to phase each channel's samples before combining.
        :type       beam_phases:       ndarray [num_slices, num_beams, num_channels]

        :returns:   Beamformed samples of shape [num_slices, num_beams, num_samples]
        :rtype:     np.ndarray
        """
        # [num_slices, num_beams, num_channels]
...
def basic_pulse_phase_offset(exp_slice: ExperimentSlice):
    """
