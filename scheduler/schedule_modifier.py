...
def main():
    ...
    if args.add:
        scd_util.add_line(args.date, args.time, args.experiment, args.prio, args.duration, args.kwargs)

    if args.remove:
        scd_util.remove_line(args.date, args.time, args.experiment, args.prio, args.duration, args.kwargs)    
