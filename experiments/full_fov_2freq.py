...
def left_half_widebeam(frequency_khz, total_antennas, antenna_spacing_m):
    ...
    half of the array.
    """
    phases = scf.easy_widebeam(total_antennas // 2, frequency_khz, antenna_spacing_m)
...
class FullFOV2Freq(ExperimentPrototype):
    def __init__(self, **kwargs):
        ...
        slice_0 = {
            ...
            "tx_antenna_pattern": left_half_widebeam(tx_freq_2, num_antennas, antenna_spacing),
        ...
        slice_1['tx_antenna_pattern'] = right_half_widebeam(tx_freq_2, num_antennas, antenna_spacing)
