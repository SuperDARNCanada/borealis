...
class MockOptions(Options):
    ...
    def __post_init__(self):
        ...
        os.environ['RADAR_ID'] = 'sas'  # Use SAS to ensure that valid hdw and restrict files are loaded.
        self.parse_hdw()
        self.parse_restrict()
...
class TestConfig(unittest.TestCase):
    ...
    def testSingleN200BadMain(self):
        ...
        with self.assertRaisesRegex(ValueError, 'rx_main_antennas and main_antenna_count are not consistent'):
            MockOptions()
    ...
    def testSingleN200BadIntf(self):
        ...
        with self.assertRaisesRegex(ValueError, 'rx_intf_antennas and intf_antenna_count are not consistent'):
            MockOptions()
    ...
    def testSingleN200BadTxMain(self):
        ...
        with self.assertRaisesRegex(ValueError, 'tx_main_antennas and main_antenna_count are not consistent'):
            MockOptions()
    ...
    def testSingleN200TxIntf(self):
        ...
        with self.assertRaisesRegex(ValueError, "Cannot connect tx channel to interferometer array"):
            MockOptions()
    ...
    def testDuplicateMainAntennaRx(self):
        ...
        with self.assertRaisesRegex(ValueError, 'rx_main_antennas has duplicate values'):
            MockOptions()
    ...
    def testDuplicateIntfAntennaRx(self):
        ...
        with self.assertRaisesRegex(ValueError, 'rx_intf_antennas has duplicate values'):
            MockOptions()
    ...
    def testDuplicateMainAntennaTx(self):
        ...
        with self.assertRaisesRegex(ValueError, 'tx_main_antennas has duplicate values'):
            MockOptions()
    ...
    def testInvalidArraySpecifierRx(self):
        ...
        with self.assertRaisesRegex(ValueError, "channel must start with either 'm' or 'i'"):
            MockOptions()
