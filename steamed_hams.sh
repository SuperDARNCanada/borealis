...
if [ "$2" = "release" ]; then
    ...
    start_exphan="sleep 0.001s; python3 -O experiment_handler/experiment_handler.py "$1" "$3" ; bash;"
    ...
    start_exphan="sleep 0.001s; python3 -O -m cProfile -o testing/python_testing/experiment_handler.cprof experiment_handler/experiment_handler.py "$1" "$3" ; bash;"
    ...
    start_exphan="sleep 0.001s; python3 experiment_handler/experiment_handler.py "$1" "$3" ; bash"
