...
if [ "$2" = "release" ]; then
    ...
    command2="echo Initialize experiment_handler.py; sleep 0.001s; python3 -m cProfile -o testing/python_testing/experiment_handler.cprof experiment_handler/experiment_handler.py "$1" ; bash;"
    command3="echo Initialize radar_control.py; sleep 0.001s; python3 -m cProfile -o testing/python_testing/radar_control.cprof radar_control/radar_control.py; bash;"
