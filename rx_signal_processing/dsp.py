...
try:
    import cupy as xp
    from cupyx.scipy.signal import fftconvolve as fftc
except ImportError:
    import numpy as xp
...
class DSP(object):
    ...
    def apply_bandpass_decimate(self, input_samples, bp_filters, mixing_freqs, dm_rate, rx_rate):
        ...
        filtered = fftc(input_samples, bp_filters)
    ...
    def apply_lowpass_decimate(self, input_samples, lp_filter, dm_rate):
        ...
        filtered = fftc(input_samples, lp_filters)
