...
imgmath_latex_preamble = (
    r"\usepackage[dvipsnames]{xcolor}"  # for rendering colors in equations
)
...
project = "Borealis"
copyright = "2018-2025, SuperDARN Canada"
...
man_pages = [(master_doc, "borealis", "Borealis Documentation", [author], 1)]
