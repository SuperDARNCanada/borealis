...
radar. The following are a couple of examples of current SuperDARN experiments.
...
Twofsound is a common variant of the normalscan experiment for SuperDARN. It has two frequencies so will
