...
if on_rtd:
  ...
  call(['git', 'clone', 'https://github.com/vtsuperdarn/hdw.dat'])

  call(['ln', '-s', 'hdw.dat/hdw.dat.sas', BOREALISPATH + '/hdw.dat.sas'])
...
man_pages = [
    (master_doc, 'borealis', 'Borealis Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Borealis', 'Borealis Documentation',
   author, 'Borealis', 'One line description of project.',
   'Miscellaneous'),
]
