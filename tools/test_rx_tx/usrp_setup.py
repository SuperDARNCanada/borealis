...
class USRPSetup(object):
    ...
    def setup(self):
        ...
        # Create streams
        self.rx_stream = self.create_rx_stream(self.options.get_cpu, self.options.get_otw,
                                               self._rx_chans)
        self.tx_stream = self.create_tx_stream(self.options.get_cpu, self.options.get_otw,
                                               self._tx_chans)
