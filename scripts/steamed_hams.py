...
def usage_msg():
    ...
    argument. The experiment handler will search for the module in the src/borealis_experiments/
...
BOREALISSCREENRC = f"""####THIS FILE IS GENERATED BY STEAMED_HAMS.PY####
...
screenrc = BOREALISSCREENRC.format(borealis_path=borealis_path, **modules)
screenrc_file = borealis_path + "/borealisscreenrc"
