...
def steamed_hams_parser():
    ...
    parser = argparse.ArgumentParser(
        usage="""steamed_hams.py experiment_module {release,debug,pyprof,rawrf,engdebug} {common,discretionary,special} [-h] [--embargo] [--rawacf-format {hdf5,dmap}] [--realtime-off] [--kwargs ...]"""
    )
    parser.add_argument(
        "experiment_module",
