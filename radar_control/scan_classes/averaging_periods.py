#!/usr/bin/python
#REVIEW 1 documentation needs to be updated. Also, can be very verbose and descriptive of these classes.
...
class AveragingPeriod():
    ...
    def __init__(self, scan, ave_keys):
        ...
        self.interface={}
        for p,q in interface_keys: # REVIEW #26 is there a particular reason for m,n,p,q as index names?
        ...
        self.clrfrqf=[] # REVIEW #41 Can "CPO" have a clrfreq flag contained within it instead?
        ...
        self.cpo_integrations=self.get_integrations() #REVIEW #26 names could use a bit more distinction or clarity between cpo_integrations and integrations.
        self.integrations=[]
    ...
    def get_integrations(self):
        ...
        for num1,num2 in self.interface.keys(): # REVIEW #39 Use iteritems to iterate over dictionary.
        ...
        i=0
        while (i<len(integ_combos)): #REVIEW #22 This is duplicate code from experiment prototype. Can make a new fn or library for this?
            k=0
