...
class Scan():
    ...
    def __init__(self, controlprog, scan_keys): #REVIEW #22/#41 Lots of duplicate code in init fn's of the scan classes. Can this be written once in a parent class and then be inherited in children.
        self.rxrate=int(float(controlprog.config[u'rx_sample_rate'])) #REVIEW #5 units
        self.keys=scan_keys
        self.cpos={}
        for i in scan_keys:
    ...
    def get_inttimes(self):
        ...
        i=0
        while (i<len(intt_combos)): #REVIEW #22 This is duplicate code from experiment prototype. Can make a new fn or library for this?
            k=0
