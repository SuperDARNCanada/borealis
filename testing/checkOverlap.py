...
def checkOverlap(array):
	...
	for pulse_index in range(0,len(array)):
		...
		for next_pulse_index in range(0,len(array)):
			if array[pulse_index] != array[next_pulse_index] and \
			   array[pulse_index][1] < array[next_pulse_index][2] and\
			   array[next_pulse_index][1] < array[pulse_index][2]:
				pulse_overlap.append((array[pulse_index][1],array[next_pulse_index][2]))
